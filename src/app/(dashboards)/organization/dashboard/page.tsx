...
import { Lightbulb, CheckCircle, FilePlus, Clock } from "lucide-react";
...
const solutiondetails = [
  {title: "Agrisense",category: "Approved",category1: "Open",category2: 12, shortdescr: "Posted by Ministry of Agriculture", longdescr: "Create an IoT-based water management solution to optimize irrigation, reduce water waste, and improve crop yields for smallholder farmers." , objective: [ "Reduce waste in agriculture by at least 30%","Improve crop yields through optimized irrigation"], submition: 125, date: "18 Feb",  },
  {title: "Agrisense",category: "Approved",category1: "Open",category2: 12, shortdescr: "Posted by Ministry of Agriculture", longdescr: "Create an IoT-based water management solution to optimize irrigation, reduce water waste, and improve crop yields for smallholder farmers." , objective: [ "Reduce waste in agriculture by at least 30%","Improve crop yields through optimized irrigation"], submition: 125, date: "18 Feb",  },
  {title: "Agrisense",category: "Approved",category1: "Open",category2: 12, shortdescr: "Posted by Ministry of Agriculture", longdescr: "Create an IoT-based water management solution to optimize irrigation, reduce water waste, and improve crop yields for smallholder farmers." , objective: [ "Reduce waste in agriculture by at least 30%","Improve crop yields through optimized irrigation"], submition: 125, date: "18 Feb",  }
]

const solutiondetail = [
  {title: "Health Management System",category: "Approved",category1: "Open",category2: 12, shortdescr: "By david Okello", time: "2 Weeks ago"  },
  {title: "Health Management System",category: "Approved",category1: "Open",category2: 12, shortdescr: "By david Okello", time: "2 Weeks ago"  },
  {title: "Health Management System",category: "Agriculture",category1: "Open",category2: 12, shortdescr: "By david Okello", time: "2 Weeks ago"  }
]
...
const Page = () => {
  return (
    <div className="flex flex-col space-y-6 p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
        {solutiondetails.map((solution, id) => (
            <div key={id} className="bg-[#0B1226] p-6 rounded-2xl shadow-md text-white">
              ...
              <div className="gap-4 my-4 flex items-center justify-between">
                <span className="bg-green-900/30 text-green-300 px-4 py-2 rounded-md text-xs">
                  {solution.category}
                </span>
                <span className="bg-[#08235F]/81 text-white/80 px-4 py-2 rounded-md text-xs">
                  {solution.category1}
                </span>
                <span className="bg-green-900/30 text-green-300 px-4 py-2 rounded-md text-[11px]">
                  {solution.category2} Submissions
                </span>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-baseline">
        <div className="">
          {solutiondetail.map((solution, id) => (
            <div key={id} className="bg-[#0B1226] p-6 rounded-2xl shadow-md text-white my-6">
              <div className="flex items-start justify-between">
              ...
              <div className="flex gap-4 mt-6 items-center justify-between">
                <span className="flex flex-row text-sm gap-2"><Clock size={18} /> {solution.time}</span>
                <button className="flex flex-row border border-white/20 text-gray-200 py-3 rounded-lg hover:bg-white/10 transition text-[13px] cursor-pointer px-6 gap-4 items-center justify-center">
                  <Eye size={16} ></Eye>View 
                </button>

                <button className="flex flex-row bg-[#061230] py-3 rounded-lg text-[13px] cursor-pointer px-6 gap-4 items-center justify-center">
        ...
        <div className="bg-[#0B1226] rounded-lg">
          <div className="flex items-center justify-between mx-20">
            <h6 className="p-6 text-lg font-semibold text-white ">Feedback review</h6>
            <p className="text-md font-semibold text-white">View All</p>
          </div>
          
          <div className="p-6 space-y-6">
            {users.map((u, i) => (
              <div key={i} className="flex mx-6 bg-[#0B1739] rounded-lg p-3 items-center justify-center">
                <div>
